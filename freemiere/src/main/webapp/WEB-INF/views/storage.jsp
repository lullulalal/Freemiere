			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li>
							<!-- 좌측메뉴바 --> <a id='myStorage' class='sideMenu'> <i
								class="fa fa-folder-open-o fa-fw"></i> 내 저장소
						</a>
						</li>
						<li><a id='shared' class='sideMenu'><i
								class="fa fa-usb fa-fw"></i> 공유 저장소</a></li>
						<li><a id='recent' class='sideMenu'><i
								class="fa fa-spinner fa-fw"></i> 최근 작업 파일</a></li>
						<li><a id='bookMark' class='sideMenu'><i
								class="fa fa-tags fa-fw"></i> 즐겨찾기</a></li>
						<li><a id='trash' class='sideMenu'><i
								class="fa fa-trash fa-fw"></i> 휴지통</a></li>
						<li><a id='edit' class='sideMenu'><i
								class="fa fa-spinner fa-fw"></i> 영상편집</a>
					</ul>
				</div>
				<!-- /.sidebar-collapse -->
			</div>
				...
				<div id="dragDropZone">
					...
					<nav class="navbar navbar-inverse navbar-fixed-bottom">
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="#"><input type="button"
									class="btn btn-outline-success" value="새폴더"></a></li>
							<li><a href="#"><input type="button"
